    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        List<DataRow> rows = snapshot.data!.docs.map((doc) {
          ...
          return DataRow(
            cells: [
              DataCell(Text(data['id_pesanan'] ?? '')),
              DataCell(Text(data['nama_produk'] ?? '')),
              DataCell(Text(data['alamat_tujuan'] ?? '')),
        ...
        return SingleChildScrollView(
          ...
          child: DataTable(
            ...
            columns: [
              DataColumn(label: _buildHeaderText('ID Pesanan')),
              DataColumn(label: _buildHeaderText('Nama Produk')),
              DataColumn(label: _buildHeaderText('Alamat')),
              DataColumn(label: _buildHeaderText('Ekspedisi')),
